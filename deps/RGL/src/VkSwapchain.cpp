...
void RGL::SwapchainVK::Resize(uint32_t width, uint32_t height)
{
    ...
    for (size_t i = 0; i < swapChainImages.size(); i++) {
        ...
        owningDevice->SetDebugNameForResource((void*)createInfo.image, VK_OBJECT_TYPE_IMAGE, debugName.c_str());
        ...
        owningDevice->SetDebugNameForResource((void*)swapChainImageViews[i], VK_OBJECT_TYPE_IMAGE_VIEW, viewDebugName.c_str());
